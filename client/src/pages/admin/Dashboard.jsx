import { ChartLineIcon, CircleDollarSignIcon, Dice1, PlayCircleIcon, StarIcon, UsersIcon } from 'lucide-react';
  ...
  return !loading ? (
    <>
      ...
      <div className='relative flex flex-wrap mt-6'>
        ...
        <div className='flex flex-wrap md:flex-row gap-6 w-full'>
